...
Upstream: [![Go Report Card](https://goreportcard.com/badge/github.com/inherelab/eget)](https://goreportcard.com/report/github.com/inherelab/eget)
[![Release](https://img.shields.io/github/release/inherelab/eget.svg?label=Release)](https://github.com/inherelab/eget/releases)
[![MIT License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/inherelab/eget/blob/master/LICENSE)
...
Before you can get anything, you have to get Eget. If you already have Eget and want to upgrade, use `eget inherelab/eget`.
...
Pre-built binaries are available on the [releases](https://github.com/inherelab/eget/releases) page.
...
```
go install github.com/inherelab/eget@latest
```

or install from HEAD:

```
git clone https://github.com/inherelab/eget
cd eget
...
(requires pandoc). You can also use `eget` to download the man page: `eget -f eget.1 inherelab/eget`.
