...
- [x] **Step 1: 对 `validateInstallMode` 做 upstream impact analysis**
...
```bash
git add internal/cli/options.go internal/cli/options_test.go internal/cli/install_cmd.go internal/cli/app.go internal/cli/app_install_test.go AGENTS.md docs/superpowers/plans/2026-07-18-install-mode-gui-normalization.md
